...
| ID | Name | Descrption |
| --- | --- | --- |
| [[Limit Software Installation\|M1033]] | Limit Software Installation | Only install extensions from trusted sources that can be verified. |
| [[User Training\|M1017]] | User Training | Train users to minimize extension use, and to only install trusted extensions.  |
| [[Execution Prevention\|M1038]] | Execution Prevention | Set an extension allow or deny list as appropriate for your security policy.  |
| [[Audit\|M1047]] | Audit | Ensure extensions that are installed are the intended ones, as many malicious extensions may masquerade as legitimate ones.  |
| [[Update Software\|M1051]] | Update Software | Ensure operating systems and software are using the most current version.  |
...
| [[IDE Extensions\|T1176.002]] | IDE Extensions |
...
[^24]: [Chrome Extension C2 Malware](https://web.archive.org/web/20240608001937/https://kjaer.io/extension-malware/)
...
[^62]: [xorrior chrome extensions macOS](https://www.xorrior.com/No-Place-Like-Chrome/)
...
[^74]: [Abramovsky VSCode Security](https://blog.checkpoint.com/securing-the-cloud/malicious-vscode-extensions-with-more-than-45k-downloads-steal-pii-and-enable-backdoors/)
