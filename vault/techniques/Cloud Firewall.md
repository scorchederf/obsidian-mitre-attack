...
aliases: 
    - T1686.001
mitre-attack: https://attack.mitre.org/techniques/T1686/001
tactic: 
     - Defense Impairment
platforms:
     - IaaS
...
| ID | Name | Descrption |
| --- | --- | --- |
| [[User Account Management\|M1018]] | User Account Management | Ensure least privilege principles are applied to Identity and Access Management (IAM) security policies.[^313]  |
...
[^98]: [Expel AWS](https://expel.com/blog/finding-evil-in-aws/)
...
[^256]: [GitHub Pacu](https://github.com/RhinoSecurityLabs/pacu)
