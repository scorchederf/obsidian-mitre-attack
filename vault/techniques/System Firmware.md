...
Adversaries may modify system firmware to persist on systems.The BIOS (Basic Input/Output System) and The Unified Extensible Firmware Interface (UEFI) or Extensible Firmware Interface (EFI) are examples of system firmware that operate as the software interface between the operating system and hardware of a computer.[^172] [^167] [^173] <br><br>System firmware like BIOS and (U)EFI underly the functionality of a computer and may be modified by an adversary to perform or assist in malicious activity. Capabilities exist to overwrite the system firmware, which may give sophisticated adversaries a means to install malicious firmware updates as a means of persistence on a system that may be difficult to detect.


### Procedure Examples
| ID | Name | Use |
| --- | --- | --- |
| [[Hacking Team UEFI Rootkit\|S0047]] | Hacking Team UEFI Rootkit | [Hacking Team UEFI Rootkit](https://attack.mitre.org/software/S0047) is a UEFI BIOS rootkit developed by the company Hacking Team to persist remote access software on some targeted systems.[^150]   |
| [[LoJax\|S0397]] | LoJax | [LoJax](https://attack.mitre.org/software/S0397) is a UEFI BIOS rootkit deployed to persist remote access software on some targeted systems.[^267]   |
| [[Trojan.Mebromi\|S0001]] | Trojan.Mebromi | [Trojan.Mebromi](https://attack.mitre.org/software/S0001) performs BIOS modification and can download and execute a file as well as protect itself from removal.[^54]  |
...
| ID | Name | Descrption |
| --- | --- | --- |
| [[Boot Integrity\|M1046]] | Boot Integrity | Check the integrity of the existing BIOS or EFI to determine if it is vulnerable to modification. Use Trusted Platform Module technology. [^297]  Move system's root of trust to hardware to prevent tampering with the SPI flash memory.[^267]  Technologies such as Intel Boot Guard can assist with this. [^12]  |
...
[^54]: [Ge 2011](http://www.symantec.com/connect/blogs/bios-threat-showing-again)
...
[^150]: [TrendMicro Hacking Team UEFI](http://blog.trendmicro.com/trendlabs-security-intelligence/hacking-team-uses-uefi-bios-rootkit-to-keep-rcs-9-agent-in-target-systems/)
...
[^167]: [Wikipedia UEFI](https://en.wikipedia.org/wiki/Unified_Extensible_Firmware_Interface)
...
[^172]: [Wikipedia BIOS](https://en.wikipedia.org/wiki/BIOS)


[^173]: [About UEFI](http://www.uefi.org/about)
