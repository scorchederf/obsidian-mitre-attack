...
aliases: 
    - T1685.006
mitre-attack: https://attack.mitre.org/techniques/T1685/006
tactic: 
     - Defense Impairment
platforms:
     - Linux - macOS
...
Adversaries may clear system logs to hide evidence of an intrusion. macOS and Linux both keep track of system or user-initiated actions via system logs. The majority of native system logging is stored under the `/var/log/` directory. Subfolders in this directory categorize logs by their related functions, such as:[^295] <br><br>* `/var/log/messages:`: General and system-related messages<br>* `/var/log/secure or /var/log/auth.log`: Authentication logs<br>* `/var/log/utmp or /var/log/wtmp`: Login records<br>* `/var/log/kern.log`: Kernel logs<br>* `/var/log/cron.log`: Crond logs<br>* `/var/log/maillog`: Mail server logs<br>* `/var/log/httpd/`: Web server access and error logs


### Procedure Examples
| ID | Name | Use |
| --- | --- | --- |
| [[JumbledPath\|S1206]] | JumbledPath | [JumbledPath](https://attack.mitre.org/software/S1206) can clear logs on all devices used along its connection path to compromised network infrastructure.[^303]  |
| [[UPSTYLE\|S1164]] | UPSTYLE | [UPSTYLE](https://attack.mitre.org/software/S1164) clears error logs after reading embedded commands for execution.[^57]  |
| [[MacMa\|S1016]] | MacMa | [MacMa](https://attack.mitre.org/software/S1016) can clear possible malware traces such as application logs.[^27]  |
| [[Proton\|S0279]] | Proton | [Proton](https://attack.mitre.org/software/S0279) removes logs from `/var/logs` and `/Library/logs`.[^225]  |
| [[TeamTNT\|G0139]] | TeamTNT | [TeamTNT](https://attack.mitre.org/groups/G0139) has removed system logs from `/var/log/syslog`.[^136]  |
| [[Rocke\|G0106]] | Rocke | [Rocke](https://attack.mitre.org/groups/G0106) has cleared log files within the /var/log/ folder.[^317]  |
| [[Salt Typhoon\|G1045]] | Salt Typhoon | [Salt Typhoon](https://attack.mitre.org/groups/G1045) has cleared logs including .bash_history, auth.log, lastlog, wtmp, and btmp.[^303]  |
| [[Sea Turtle\|G1041]] | Sea Turtle | [Sea Turtle](https://attack.mitre.org/groups/G1041) has overwritten Linux system logs and unsets the Bash history file (effectively removing logging) during intrusions.[^161]  |
...
[^136]: [Aqua TeamTNT August 2020](https://blog.aquasec.com/container-security-tnt-container-attack)
...
[^161]: [Hunt Sea Turtle 2024](https://www.huntandhackett.com/blog/turkish-espionage-campaigns)
...
[^225]: [objsee mac malware 2017](https://objective-see.com/blog/blog_0x25.html)
...
[^295]: [Linux Logs](https://www.eurovps.com/blog/important-linux-log-files-you-must-be-monitoring/)
...
[^303]: [Cisco Salt Typhoon FEB 2025](https://blog.talosintelligence.com/salt-typhoon-analysis/)
...
[^317]: [Anomali Rocke March 2019](https://www.anomali.com/blog/rocke-evolves-its-arsenal-with-a-new-malware-family-written-in-golang)
