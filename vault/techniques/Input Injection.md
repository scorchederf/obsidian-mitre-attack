...
aliases: 
    - T1674
mitre-attack: https://attack.mitre.org/techniques/T1674
tactic: 
     - Execution
platforms:
     - Windows - macOS - Linux
...
| [[Execution Prevention\|M1038]] | Execution Prevention | Denylist scripting and use application control where appropriate. For example, PowerShell Constrained Language mode can be used to restrict access to sensitive or otherwise dangerous language elements such as those used to execute arbitrary Windows APIs or files (e.g., `Add-Type`).[^319]  |
...
[^4]: [BleepingComputer USB](https://www.bleepingcomputer.com/news/security/fbi-hackers-sending-malicious-usb-drives-and-teddy-bears-via-usps/)
...
[^189]: [BleepingComputer BackSwap](https://www.bleepingcomputer.com/news/security/backswap-banking-trojan-uses-never-before-seen-techniques/)
...
[^283]: [welivesecurity BackSwap](https://www.welivesecurity.com/2018/05/25/backswap-malware-empty-bank-accounts/)
