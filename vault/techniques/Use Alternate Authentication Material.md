...
| [[Active Directory Configuration\|M1015]] | Active Directory Configuration | Configure Active Directory to prevent use of certain techniques; use SID Filtering, etc. |
| [[Account Use Policies\|M1036]] | Account Use Policies | Where possible, consider restricting the use of authentication material outside of expected contexts. |
...
[^132]: [MSTIC FoggyWeb September 2021](https://www.microsoft.com/security/blog/2021/09/27/foggyweb-targeted-nobelium-malware-leads-to-persistent-backdoor/)
...
[^137]: [NIST MFA](https://csrc.nist.gov/glossary/term/multi_factor_authentication)
...
[^196]: [NIST Authentication](https://csrc.nist.gov/glossary/term/authentication)
