...
mitre-attack: https://attack.mitre.org/mitigations/M1039
---
...
| ID | Name | Description |
| --- | --- | --- |
| [[Prevent Command History Logging\|T1690]] | Prevent Command History Logging | Prevent users from changing the `HISTCONTROL`, `HISTFILE`, and `HISTFILESIZE` environment variables. [^1]  |
| [[Clear Command History\|T1070.003]] | Clear Command History | Making the environment variables associated with command history read only may ensure that the history is preserved.[^1]  |
